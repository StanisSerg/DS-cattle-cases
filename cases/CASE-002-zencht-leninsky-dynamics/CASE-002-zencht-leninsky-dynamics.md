...
- Рацион: используемый для групп 2,3,4,5,6,7,8, 19 (соматика) — [2026-06-08 Используемый Зенченко Ленинский.pdf](<Rations/2026-06-08 Используемый Зенченко Ленинский.pdf>)
...
- Рацион: используемый для групп раздоя 15, 1 — [2026-06-08 Используемый 15 1.pdf](<Rations/2026-06-08 Используемый 15 1.pdf>)
...
- Рацион гр 15 и 1: [2026-06-10 Ленинское 15 1 новый.pdf](<Rations/2026-06-10 Ленинское 15 1 новый.pdf>)
- Рацион гр 2-8, 19: [2026-06-10 Ленинский 2,7,8 новый.pdf](<Rations/2026-06-10 Ленинский 2,7,8 новый.pdf>)
...
### Фактические результаты (обновлённый датасет 2026-05-02 — 2026-08-19)
...
| Реализация молока, тыс. л/сут |                        24,4 |                      27,3 |                   **+2,9** |
| Дойные головы, гол.                   |                          869 |                        850 | 764 (02.05) → пик 882 → ~850 |

> Графики перегенерированы из актуальных md-данных 20.08.2026: рис. 1 — динамика 08.06–19.08, рис. 2 — группы по 4 визитам (09.06, 07.07, 10.07, 12.08).

![Динамика производства Ж/К №2](charts/milk_yield_realization_Len_2026-06_08.png)

*Рис. 1. Удой на корову и реализация молока на Ж/К №2, 2026-06-08 — 2026-08-19: замеры, скользящее среднее за 3 дня, линейный тренд.*
...
### Динамика после 09.07.2026 (июль–август, по суточным сводкам)

| Период | Удой на корову, л/сут | Реализация, тыс. кг/сут | Комментарий |
|---|---|---|---|
| 09.07 | 31,6 | 26,9 | Жара до +33 °C, высокая влажность; молоко −800 л за день (заметка пилота 09.07: рацион не менялся, мониторинг остатков) |
| 12.07 | **28,9** | 24,4 | Минимум после интервенции: −2,5 тыс. кг за 3 дня на фоне жары |
| 13.07–23.07 | 29,0 → 31,8 | 24,5 → 26,8 | Постепенное восстановление по мере спада жары |
| 26.07–29.07 | 30,6–31,9 | 26,1–26,7 | Стабилизация |
| 13.08–19.08 | 30,5–32,1 | 26,1–27,3 | 19.08: **32,1 л/гол**, 27,3 тыс. кг, 850 дойных голов |

**Жир в молоке (Ж/К №2):** снижение с 3,8–3,9 % (июнь — начало июля) до 3,5–3,8 % (август); минимум 3,5 % — 13.08.

**Ж/К №1 за тот же период:** рост до 34,9 л/гол (16.08); на 19.08 — 32,45 л/гол, реализация 18,8 тыс. кг, поголовье выросло 525 → 580 гол.

### Физическая структура TMR после интервенции (пенсильванские сита)

**Источник:** [`Сита.xlsx`](raw/Сита.xlsx), лист «Лист1», дата пробы **2026-07-08**, объект — **группа 2**.
...
| **09–12.07.2026** | Жара до **+33 °C** при высокой влажности; рацион не менялся (решение пилота: мониторинг остатков, при больших остатках — снижение основных кормов) | Падение до 28,9 л/гол (12.07) — минимум после интервенции; реализация −2,5 тыс. кг за 3 дня |
| **13–23.07.2026** | Спад жары | Восстановление до 31,8 л/гол (23.07) |
| **24.07–19.08.2026** | Стабильные условия, рацион без изменений | Стабилизация 30,5–32,1 л/гол; на 19.08 — 32,1 л, реализация 27,3 тыс. кг |

**Интерпретация:**
- Фактический прирост молока **+4,1 л/сут** (28,0 → 32,1 на 19.08.2026) оказался выше прогноза AMTS **+1,6 л/сут**, потому что модель не учитывала фактическую нестабильность базового рациона (смешение рецептов до 08.06.2026).
- Падения продуктивности 20.06, 6–7.07 и 09–12.07 связаны с внешними факторами (новая траншея + жара, вакцинация + отбор крови, жара +33 °C при высокой влажности), а не с ошибкой рациона.
- После устранения перепутанных рецептов (с 07.07.2026) и стабилизации погодных условий тренд восстановился и удерживается до 19.08.2026.
...
**Сравнение с Ж/К №1 (19.08.2026):**

|                                 Показатель | Ж/К №2 | Ж/К №1 | Разница |
| ---------------------------------------------------: | --------: | --------: | -------------: |
|                Удой на корову, л/сут |      32,1 |      32,5 |           −0,4 |
| Реализация молока, тыс. л/сут |      27,3 |      18,8 | **+8,5** |
|                Дойные головы, гол. |       850 |       580 |         +270 |

Через 2 месяца после интервенции Ж/К №2 удерживает паритет по удою на корову с Ж/К №1 (разница в пределах 0,5 л); преимущество по реализации сохраняется за счёт поголовья.

### Визуализация динамики по комплексам (Ж/К №1 vs Ж/К №2)

*Графики сравнения комплексов (рис. 4–7 прежней версии) удалены 20.08.2026; перегенерация из актуальных md-данных — отдельный шаг. Ключевые цифры сравнения — в таблице выше.*
...
- Ж/К №2 (Ленинский), 2026-05-02 — 2026-08-19: [milk_dynamics_Len_2026-05.md](raw/milk_dynamics_Len_2026-05.md)
- Ж/К №1 (Рублёвка), 2026-05-02 — 2026-08-19: [milk_dynamics_Rubl_2026-05.md](raw/milk_dynamics_Rubl_2026-05.md)

**Визуализации отчёта:**

- Динамика производства Ж/К №2 (удой + реализация, 08.06–19.08): [milk_yield_realization_Len_2026-06_08.png](charts/milk_yield_realization_Len_2026-06_08.png)
- Сравнение групп по 4 визитам (09.06–12.08): [group_productivity_comparison.png](charts/group_productivity_comparison.png)
- Удой и дневная температура (июнь–июль): [milk_yield_and_temperature_Len_2026-06_07.png](charts/milk_yield_and_temperature_Len_2026-06_07.png)

**Рационы AMTS:**

- Гр. 2–8 старый: [2026-06-08 Используемый Зенченко Ленинский.pdf](<Rations/2026-06-08 Используемый Зенченко Ленинский.pdf>)
- Гр. 2–8 новый: [2026-06-10 Ленинский 2,7,8 новый.pdf](<Rations/2026-06-10 Ленинский 2,7,8 новый.pdf>)
- Гр. 15, 1 старый: [2026-06-08 Используемый 15 1.pdf](<Rations/2026-06-08 Используемый 15 1.pdf>)
- Гр. 15, 1 новый: [2026-06-10 Ленинское 15 1 новый.pdf](<Rations/2026-06-10 Ленинское 15 1 новый.pdf>)

**Дополнительные визуализации:**

> Вспомогательные графики прежней версии (Зенченко_*, groups_delta, sita_tmr_group2, psps_*) удалены 20.08.2026; перегенерация из актуальных md-данных — отдельный шаг.
...
|-----------|-----|-------------------|
| Сущность | CS.ENTITY.030 | DMI — фактическое и расчётное потребление корма лежит в основе кейса |
| Сущность | CS.ENTITY.188 | NDF — структура рациона и физическая форма TMR |
| Сущность | CS.ENTITY.189 | Рубцовое брожение — изменение переваримости при снижении соломы |
| Сущность | CS.ENTITY.193 | Сырой протеин — баланс CP в рационе |
| Сущность | CS.ENTITY.200 | NFC / неструктурные углеводы — концентрированность рациона |
| Сущность | CS.ENTITY.202 | Размер частиц — пенсильванские сита и физическая структура TMR |
| Сущность | CS.ENTITY.213 | Сортировка — риск неравномерного потребления компонентов |
| Сущность | CS.ENTITY.215 | NASEM 2021 — модель, лежащая в основе расчётов AMTS |
| Метод | CS.METHOD.006 | Системная оценка кормления при визите на ферму |
| Метод | CS.METHOD.007 | FPF-система решения типовых проблем технолога |
| SoTA | CS.SOTA.056 | Lean 2006 — минеральный менеджмент transition period |
| SoTA | CS.SOTA.197 | Milk fat depression — риск при изменении структуры рациона |
| SoTA | CS.SOTA.201 | NASEM 2021 protein — баланс протеина в рационе |
| DPF | CS.DPF.001 | Принципы применения CNCPS для кормления КРС |
...
*Обновлён: 2026-07-09 — проверка completeness по TEMPLATE-CASE.md; дозаполнены BCS, DMI baseline, лабораторные показатели, структура интервенции; графики перегенерированы из обновлённых xlsx-данных (2026-05-02 — 2026-07-09) скриптом `scripts/generate_charts.py`*
