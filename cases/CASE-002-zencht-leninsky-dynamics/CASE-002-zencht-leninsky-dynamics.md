...
### Фактические результаты (обновлённый датасет 2026-05-02 — 2026-07-09)
...
*Рис. 1. Динамика удоя на корову и реализации молока на Ж/К №2 за период 2026-05-02 — 2026-07-09. График включает базовый майский период, интервенцию 10.06.2026 и фактические суточные данные до 09.07.2026.*
...
![Сравнение продуктивности групп](charts/groups_comparison_bars.png)

*Рис. 2. Сравнение продуктивности по группам на 09.06.2026 и 07.07.2026.*

![Изменение продуктивности групп](charts/groups_delta.png)
...
*Рис. 4. Сравнение продуктивности на корову по Ж/К №1 и Ж/К №2 (2026-05-02 — 2026-07-09). Ж/К №2: 29,0 → 31,6 л/сут; Ж/К №1: 31,8 → 33,0 л/сут. Ж/К №2 сократил отставание, но остался чуть ниже Ж/К №1 на конец периода.*

![Разница по продуктивности между комплексами](charts/Зенченко_разница_между_фермами.png)

*Рис. 5. Разница в продуктивности (Ж/К №2 − Ж/К №1), л/сут. Максимальное отставание Ж/К №2 (−4,3 л/сут) зафиксировано 09.06.2026; к 09.07.2026 разрыв сократился до ~−1,3 л/сут.*

![Сравнение реализации молока](charts/Зенченко_реализация.png)

*Рис. 6. Сравнение реализации молока по комплексам (2026-05-02 — 2026-07-09), л/сут. Ж/К №2: 22,2 → 26,9 тыс. л/сут; Ж/К №1: 16,4 → 18,5 тыс. л/сут.*

![Динамика дойного поголовья](charts/Зенченко_дойное_поголовье.png)

*Рис. 7. Динамика дойного поголовья по комплексам (2026-05-02 — 2026-07-09). Ж/К №2: 764 → 851 гол.; Ж/К №1: 515 → 560 гол. На Ж/К №2 отмечен рост поголовья до пика ~882 голов, затем снижение до ~850 к концу июня.*
...
- Динамика производства Ж/К №2: [Ж_К_№2_individual.png](charts/Ж_К_№2_individual.png)
- Динамика производства Ж/К №1: [Ж_К_№1_individual.png](charts/Ж_К_№1_individual.png)
- Сравнение групп: [groups_comparison_bars.png](charts/groups_comparison_bars.png)
- Изменение продуктивности групп: [groups_delta.png](charts/groups_delta.png)
- Физическая структура TMR группы 2 (2026-07-08): [sita_tmr_group2.png](charts/sita_tmr_group2.png)
...
> Все графики ниже перегенерированы из обновлённых `Зенченко Динамика производства.xlsx` и `Группы.xlsx` (период 2026-05-02 — 2026-07-09). Четыре графика встроены в раздел «Визуализация динамики по комплексам»: продуктивность на голову, разница между комплексами, реализация молока, динамика дойного поголовья.

Оставшиеся вспомогательные графики:

- [Зенченко_scatter.png](charts/Зенченко_scatter.png) — scatter «Реализация vs продуктивность», размер точки пропорционален дойному поголовью; показывает масштабный эффект Ж/К №2.
- [Зенченко_индексы.png](charts/Зенченко_индексы.png) — индексы продуктивности и реализации (начало периода = 100); Ж/К №2: +17% по продуктивности и +14% по реализации; Ж/К №1: +1% и +6% соответственно.
- [Зенченко_скользящее_среднее.png](charts/Зенченко_скользящее_среднее.png) — скользящее среднее за 7 дней: продуктивность на голову (вверху) и реализация (внизу).
- [Зенченко_совмещенный_график.png](charts/Зенченко_совмещенный_график.png) — совмещённая динамика удоя на корову и общей реализации для каждого комплекса на одном полотне (двойная ось).
